#------------------------------------------------------------------------------
#PROCESS: 		SFTPDownloadFiles.ps1
#PARAMS: 		$Username, $Password, $HostName, $RemotePath, $LocalPath,
#				$SshHostKeyFingerprint, $FileMask, $Remove, $TransferMode,
#				$PortNumber
#USAGE:			SFTPDownloadFiles "Testuser" "P@$$w0rd!" "test.ftp.com"
#				"/Out/" "C:\incoming\"
#				"ssh-rsa 1024 00:12:34:56:78:90:ab:cd:ef:a0:12:34:56:78:90"
#AUTHOR: 		Nicholas Raymond
#LAST EDITED:	16 JAN 2015
#
#DESCRIPTION:	This script connects to a remote SFTP server and downloads the
#				files specified. You can download a single file or use the
#				$FileMask parameter to download multiple files of the same
#				type.
#------------------------------------------------------------------------------
Function SFTPDownloadFiles {
    ...
    try
    {
		...
		$result = $session.GetFiles($remotePath, $localPath, $remove, $TransferOptions)
